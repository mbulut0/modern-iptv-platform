...
function middleware(request) {
    ...
    const isAuthenticated = authCookie?.value ? JSON.parse(decodeURIComponent(authCookie.value)).state.isAuthenticated : false;
    // Redirect logic
    if (isPublicPath && isAuthenticated) {
        // If user is authenticated and trying to access login page, redirect to dashboard
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$spec$2d$extension$2f$response$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL('/live', request.url));
    }
    if (!isPublicPath && !isAuthenticated) {
